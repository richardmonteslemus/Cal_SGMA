...
editor: visual
---
[Link to Github Repository](https://github.com/richardmonteslemus/Cal_SGMA)
This repository contains code, file structures, and references for the following California Sustainable Groundwater Management Act analysis.
